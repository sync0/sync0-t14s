(use-package org-agenda
  ...
  (org-agenda-files
   (seq-filter
    (lambda (file)
      (not (string-match-p "archive\\.org$" file)))
  ...
  (org-agenda-category-icon-alist `(
                                    ...
                                    ("[Rr]eadings" ,(list (all-the-icons-material "import_contacts" :height 1.2)) nil nil :ascent center)
                                    ...
                                    ("[Th]ese" ,(list (all-the-icons-material "school" :height 1.2)) nil nil :ascent center)
