;;; /u/sy/beebe/emacs/bibtex-mods.el, Thu Jun 14 16:11:10 2018
;;; Edit by Nelson H. F. Beebe <beebe@math.utah.edu>
;;; Revise the 10 (bibtex-entry ...) calls to use new-style backquote
;;; syntax instead of the old style:
;;;
;;; old:   (bibtex-entry "Article"
;;;		(` ("author" "title" "journal" "volume" "number" "pages" "month" "year"
;;;		    "DOI" "URL" ("acknowledgement" . (, bibtex-default-acknowledgement))))
;;;		'("note" "keywords" "remark" "fjournal" "journal-URL"))
;;;
;;; new:
...
;;;		'("note" "keywords" "remark" "fjournal" "journal-URL"))
;;;
;;; Both styles are supported back to 1997-vintage emacs-19, but the
;;; old style is no longer recognized in 2018-vintage emacs-27.
;;;
;;; /u/sy/beebe/emacs/bibtex-mods.el, Fri Aug 28 11:01:37 2015
;;; Edit by Nelson H. F. Beebe <beebe@gamma.math.utah.edu>
;;; Revise bibtex-ENTRYTYPE() functions to make more keys
;;; mandatory, and fewer optional, and add additional fields
;;; to reflect current recommended bibliographic practices.
;;; Make a few tweaks in code that depends on emacs-version.
;;;
;;; /u/sy/beebe/emacs/bibtex-mods.el, Sun Nov 16 11:24:54 2014
;;; Edit by Nelson H F Beebe <beebe@math.utah.edu>
;;; In function update-bibdate, add any needed preceding comma before
;;; inserting the bibdate key/value pair.
;;;
...
;;;
;;; [28-Aug-2015] Add crossref to required fields in @InXXX{...}
;;; entries to encourage use of cross references to complete
;;; @Book{...} or @Proceedings{...} entry.  Revise required and
;;; optional fields in most entries to reflect common practice, and
;;; reduce the number of optional fields, because they require extra
;;; keystrokes to clean up.  Also, remove price field from all
;;; entries,  because it is rarely needed, and soon obsoleted by
;;; inflation.
...
(defun bibtex-Book ()
  (interactive)
  (bibtex-entry "Book"
		`("author" "title" "publisher" "address" "pages" "year"
		    "DOI" "ISBN" "ISBN-13" "LCCN" "URL"
		     ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "editor" "volume" "number" "series" "edition" "month" "note" )))

(defun bibtex-InBook ()
  (interactive)
  (bibtex-entry "InBook"
		`("author" "title" "crossref" "chapter" "publisher"
		    "address" "pages" "year" "DOI" "ISBN" "ISBN-13" "LCCN" "URL"
		    ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "editor" "volume" "number" "series" "edition" "month" "type" "note"
		   "book-DOI" "book-URL" )))

(defun bibtex-InCollection ()
  (interactive)
  (bibtex-entry "InCollection"
		`("author" "title" "booktitle" "crossref" "publisher"
		    "address" "pages" "year" "DOI" "ISBN" "ISBN-13" "LCCN" "URL"
		    ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "editor" "volume" "number" "series" "type" "chapter"
		   "edition" "month" "note" "book-DOI" "book-URL" )))


(defun bibtex-InProceedings ()
  (interactive)
  (bibtex-entry "InProceedings"
		`("author" "editor" "title" "booktitle" "crossref" "publisher" "address"
		    "pages" "year" "DOI" "ISBN" "ISBN-13" "LCCN" "URL"
		    ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "volume" "number" "series" "organization" "month"
		   "note" "book-DOI" "book-URL" )))
...
BibTeX 1.0."
  ...
  (bibtex-entry "Periodical"
		...
		'("editor" "organization" "volume" "number" "pages"
		  ...
		  "howpublished" "note" "keywords")))

(defun bibtex-Proceedings ()
  (interactive)
  (bibtex-entry "Proceedings"
		`("editor" "booktitle" "title" "publisher" "address" "pages" "year"
		    "DOI" "ISBN" "ISBN-13" "LCCN" "URL"
		     ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "volume" "number" "series" "organization" "month" "note" )))

(defun bibtex-PhdThesis ()
  (interactive)
  (bibtex-entry "PhDThesis"
		`("author" "title" "school" "address" "type" "year" "URL"
		     ("acknowledgement" . ,bibtex-default-acknowledgement))
		'( "month" "note" )))
...
spacing consistent with the output of bibclean."
  ...
  (if (string-equal (buffer-substring (match-beginning 0) (match-end 0)) "}")
      (progn
	(beginning-of-line)
	;; ensure that the previous key = value line ends in a comma
	(backward-char 1)
