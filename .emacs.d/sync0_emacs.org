...
initialize some bibtex variables
(sync0-erase /home/sync0/.emacs.d/sync0-vars/sync0-bibtex-today-keys.txt)
...
** ebib
This configuration was heavily copied from : https://ogbe.net/emacs/references
