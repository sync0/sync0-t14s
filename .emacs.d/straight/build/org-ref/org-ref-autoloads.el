...
Entries come from `org-ref-bibtex-journal-abbreviations'." t)
...
Hook function to replace non-ascii characters in a bibtex entry." t)
...
Stop showing messages in minibuffer when on a link." t)
...
Completion function for a ref link." t)

(autoload 'org-pageref-insert-ref-link "org-ref-core" "\
Insert a pageref link with completion." t)
...
Save in the default link type." t)
...
assumes point is in
the entry of interest in the bibfile.  but does not check that." t)
...
file.  Makes a new buffer with clickable links." t)
...
Print a minibuffer message about the link that point is on." t)
...
Helm command to insert glossary and acronym entries as links." t)
...
This widens the file so that all links go to the right place." t)

(autoload 'helm-tag-bibtex-entry "org-ref-helm" "\
Helm interface to add keywords to a bibtex entry.
Run this with the point in a bibtex entry." t)
...
Use helm and ‘helm-bibtex’ for completion." t)
...
the completion sources in the background so the initial call to ‘org-ref-helm-insert-cite-link’ is much faster." t)
...
(autoload 'org-ref-latex-debug "org-ref-latex" nil t)

(autoload 'org-ref-latex-click "org-ref-latex" "\
Jump to entry clicked on." t)
...
Use reftex and org-mode for completion." t)

(autoload 'org-ref-open-notes-from-reftex "org-ref-reftex" "\
Call reftex, and open notes for selected entry." t)
...
Give message of current citation at point." t)
...
Copy a summary for the citation at point to the clipboard." t)
...
directory.  You can also specify a new file." t)
